...

{
...

    {
        ...
        ui->clientStatusLabel->setText(tr("open success!").arg(fileName));
...

{
...

    {
        ...
        ui->clientStatusLabel->setText(tr("transfer success").arg(fileName));
...

{
    ...
    ui->clientStatusLabel->setText("client ready");
